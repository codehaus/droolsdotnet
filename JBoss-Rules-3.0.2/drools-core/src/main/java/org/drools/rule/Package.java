...
public class Package
    ...
    public Package(final String name,
        ...
        {
        	try {
				Class clazz = Class.forName("cli.org.drools.dotnet.semantics.DotnetPackageCompilationData");
				
				//this.packageCompilationData = (PackageCompilationData)clazz.getConstructors()[0].newInstance(new Object[]{parentClassLoader});
				this.packageCompilationData = (PackageCompilationData)clazz.getConstructor(new Class[]{ClassLoader.class}).newInstance(new Object[]{parentClassLoader});
