...
public class Rule
    ...
    private void addDeclarations(final GroupElement ce) {
        for ( final Iterator it = ce.getChildren().iterator(); it.hasNext(); ) {
            ...
            if ( obj instanceof Column ) {
                addDeclarations( (Column) obj );
            } else if ( obj instanceof GroupElement ) {
                addDeclarations( (GroupElement) obj );
            }
        }
    }
    ...
    private int getSpecifity(final GroupElement ce) {
        ...
        for ( final Iterator it = ce.getChildren().iterator(); it.hasNext(); ) {
            final Object obj = it.next();
            if ( obj instanceof Column ) {
                specificity += getSpecifity( (Column) obj );
            } else if ( obj instanceof GroupElement ) {
                specificity += getSpecifity( (GroupElement) obj );
            }
        }
        return specificity;
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if ( obj == null || obj.getClass() != Rule.class ) {
            return false;
        }
