...
class LeapsFactHandleFactory implements FactHandleFactory {
     ...
     */
    public final InternalFactHandle newFactHandle( final Object obj ) {
        return new LeapsFactHandle( this.getNextId( ), obj );
    }
     ...
     * @return leaps handle
     */
    public final InternalFactHandle newFactHandle( final long newId, final Object obj ) {
        return newFactHandle( obj );
    }
