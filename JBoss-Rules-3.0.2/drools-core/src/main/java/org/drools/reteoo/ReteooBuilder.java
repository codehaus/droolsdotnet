...
class ReteooBuilder
    ...
    private boolean hasColumns(final GroupElement ge) {
        for ( final Iterator it = ge.getChildren().iterator(); it.hasNext(); ) {
            ...
            if ( obj instanceof Column || (obj instanceof GroupElement && hasColumns( (GroupElement) obj )) ) {
                return true;
            }
        }
        return false;
    ...
    private void addRule(final And and,
        ...
        for ( final Iterator it = and.getChildren().iterator(); it.hasNext(); ) {
            ...
            if ( obj instanceof EvalCondition ) {
                final EvalCondition eval = (EvalCondition) obj;
            ...
            if ( obj instanceof Column ) {
                ...
                binder = attachColumn( (Column) obj,
                                       and,
                                       true );
                ...
                GroupElement ce = (GroupElement) obj;
    ...
    private void attachQuery(final String queryName) {
        ...
        FieldValue fieldInter = null; 

        if(DroolsEnv.isJava())
    	{
    		fieldInter = FieldFactory.getFieldValue( queryName,
    	...
    	else
    	{
    		Class cl;
			try {
				cl = Class.forName("cli.org.drools.dotnet.semantics.DotnetFieldFactory");
				Method method = cl.getMethod("getFieldValue", new Class[]{Class.forName("java.lang.String"), Class.forName("java.lang.Integer")});
	    		fieldInter = (FieldValue)method.invoke(null, new Object[]{queryName,new java.lang.Integer(Evaluator.STRING_TYPE)});
			} catch (Exception e) {
				e.printStackTrace();
			}
        ...
        final FieldValue field = fieldInter;
        Evaluator eval = null;
        if(DroolsEnv.isJava())
        {
        	 eval = EvaluatorFactory.getEvaluator( Evaluator.STRING_TYPE,
                                                                   Evaluator.EQUAL );
        }
        else
    	{
    		try
    		{
	    		...
	    		Method method = cl.getMethod("getEvaluator", new Class[]{Class.forName("java.lang.Integer"), Class.forName("java.lang.Integer")});
	    		eval = (Evaluator)method.invoke(null, new Object[]{new Integer(Evaluator.STRING_TYPE), new Integer(Evaluator.EQUAL)});
    		}
    		catch(Exception e)
    		{
    ...
    public List attachAlphaNodes(final Column column,
        ...
        for ( final Iterator it = constraints.iterator(); it.hasNext(); ) {
            ...
            if ( obj instanceof Declaration ) {
                final Declaration declaration = (Declaration) obj;
                // Add the declaration the map of previously bound declarations
                this.declarations.put( declaration.getIdentifier(),
                                       declaration );
                continue;
            ...
            final FieldConstraint fieldConstraint = (FieldConstraint) obj;
    ...
    public void removeRule(final Rule rule) {
        ...
        final Object obj = this.rules.get( rule );

        final BaseNode[] nodes = (BaseNode[]) obj;
