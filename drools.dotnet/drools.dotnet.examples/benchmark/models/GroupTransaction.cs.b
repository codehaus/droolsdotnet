...
namespace org.drools.benchmark.models
{
	...
	{
		virtual public System.String[] AccountIds
		{
			get
			{
			...
			set
			{
				if (value != this.accountIds)
				{
					System.String[] old = this.accountIds;
		...
		protected internal System.String[] accountIds = null;
