...
public class Table implements Serializable {
    ...
    public void add( final Object obj ) {
        final TableRecord newRecord = new TableRecord( obj );
        if (this.empty) {
    ...
    public void remove( final Object obj ) {
        if (!this.empty) {
            try {
                final TableRecord record = (TableRecord) this.set.tailSet( new TableRecord( obj ) )
                                                                 .first( );
    ...
    /**
     * @param obj
     * @return indicator of presence of given obj in the table
     */
    public boolean contains( final Object obj ) {
        boolean ret = false;
        if (!this.empty) {
            ret = this.set.contains( new TableRecord( obj ) );
        }
        return ret;
    }
    ...
    public Object top() {
        return this.headRecord.obj;
    }

    public Object bottom() {
        return this.tailRecord.obj;
    }

    public static TableIterator singleItemIterator( final Object obj ) {
