...
public abstract class AbstractWorkingMemory
    ...
    public Object getGlobal(final String name) {
        final Object obj = this.globals.get( name );
        return obj;
    }
    ...
    public List getObjects(final Class objectClass) {
        ...
        for ( final Iterator it = this.assertMap.keySet().iterator(); it.hasNext(); ) {
            final Object obj = ((InternalFactHandle) it.next()).getObject();
     ...
     * @see WorkingMemory
     */
    public FactHandle assertObject(final Object obj) throws FactException {
        return assertObject( obj, /* Not-Dynamic */
                             false,
                             false,
                             null,
                             null );
     ...
     * @see WorkingMemory
     */
    public FactHandle assertLogicalObject(final Object obj) throws FactException {
        return assertObject( obj, /* Not-Dynamic */
                             false,
                             true,
                             null,
    ...
    public FactHandle assertObject(final Object obj,
                                   final boolean dynamic) throws FactException {
        return assertObject( obj,
                             dynamic,
                             false,
                             null,
                             null );
    ...
    public FactHandle assertLogicalObject(final Object obj,
                                          final boolean dynamic) throws FactException {
        return assertObject( obj,
                             dynamic,
                             true,
    ...
    public FactHandle assertObject(final Object obj,
        ...
        if ( obj == null ) {
            // you cannot assert a null obj
            return null;
        }
        InternalFactHandle handle = null;
        this.lock.lock();
        try {
            // check if the obj already exists in the WM
            handle = (InternalFactHandle) this.assertMap.get( obj );

            EqualityKey key = null;

            if ( handle == null ) {
                // lets see if the obj is already logical asserted
                key = this.tms.get( obj );
            } else {
                ...
                if ( key.getStatus() == EqualityKey.STATED ) {
                    // return null as you cannot justify a Stated obj.
                    return handle;
                }

                if ( !logical ) {
                    // this obj was previously justified, so we have to
                    // override it to Stated
                    key.setStatus( EqualityKey.STATED );
                    this.tms.removeLogicalDependencies( handle );
                } else {
                    // this was obj is already justified, so just add new
                    // logical dependency
            ...
            if ( key == null ) {
                ...
                // assert
                handle = this.handleFactory.newFactHandle( obj );
    ...
    protected void addPropertyChangeListener(final Object obj) {
        try {
            final Method method = obj.getClass().getMethod( "addPropertyChangeListener",
            ...
            System.err.println( "Warning: The addPropertyChangeListener method" + " on the class " + obj.getClass() + " does not take" + " a simple PropertyChangeListener argument" + " so Drools will be unable to process JavaBean"
            ...
            System.err.println( "Warning: The addPropertyChangeListener method" + " on the class " + obj.getClass() + " threw an InvocationTargetException" + " so Drools will be unable to process JavaBean"
                                + " PropertyChangeEvents on the asserted Object: " + e.getMessage() );
        } catch ( final SecurityException e ) {
            System.err.println( "Warning: The SecurityManager controlling the class " + obj.getClass() + " did not allow the lookup of a" + " addPropertyChangeListener method" + " so Drools will be unable to process JavaBean"
                                + " PropertyChangeEvents on the asserted Object: " + e.getMessage() );
        }
    }
    ...
    protected void removePropertyChangeListener(final FactHandle handle) throws NoSuchFactObjectException {
        ...
        try {
            ...
            System.err.println( "Warning: The removePropertyChangeListener method" + " on the class " + obj.getClass() + " does not take" + " a simple PropertyChangeListener argument" + " so Drools will be unable to stop processing JavaBean"
                                + " PropertyChangeEvents on the retracted Object" );
        } catch ( final IllegalAccessException e ) {
            System.err.println( "Warning: The removePropertyChangeListener method" + " on the class " + obj.getClass() + " is not public" + " so Drools will be unable to stop processing JavaBean" + " PropertyChangeEvents on the retracted Object" );
        } catch ( final InvocationTargetException e ) {
            System.err.println( "Warning: The removePropertyChangeL istener method" + " on the class " + obj.getClass() + " threw an InvocationTargetException" + " so Drools will be unable to stop processing JavaBean"
                                + " PropertyChangeEvents on the retracted Object: " + e.getMessage() );
        } catch ( final SecurityException e ) {
            System.err.println( "Warning: The SecurityManager controlling the class " + obj.getClass() + " did not allow the lookup of a" + " removePropertyChangeListener method" + " so Drools will be unable to stop processing JavaBean"
                                + " PropertyChangeEvents on the retracted Object: " + e.getMessage() );
        }
    }

    // /**
    // * Associate an obj with its handle.
    // *
    // * @param handle
    // * The handle.
    // * @param obj
    ...
    public void retractObject(final FactHandle factHandle,
        ...
        try {
            ...
            final Object obj = handle.getObject();
    ...
    public void modifyObject(final FactHandle handle,
                             final Object obj) throws FactException {
        modifyObject( handle,
                      obj,
                      null,
                      null );
    ...
    public void propertyChange(final PropertyChangeEvent event) {
        ...
        try {
            modifyObject( getFactHandle( obj ),
                          obj );
