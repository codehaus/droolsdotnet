...
import org.drools.util.asm.IClassFieldInspector;
import org.drools.util.asm.IntrospectionFactory;
...
public class ClassFieldExtractorFactory {
    ...
    public static BaseClassFieldExtractor getClassFieldExtractor(final Class clazz,
        ...
        try 
        {
        	...
        	//IClassFieldInspector inspector = new ClassFieldInspector(clazz);
        	IClassFieldInspector inspector = IntrospectionFactory.CreateClassFieldInspector(clazz);
