...
class Rete extends ObjectSource
    ...
    public void assertObject(final DefaultFactHandle handle,
        ...
        ObjectTypeNode[] cachedNodes = (ObjectTypeNode[]) memory.get( obj.getClass() );
        if ( cachedNodes == null ) {
            cachedNodes = getMatchingNodes( obj );
            memory.put( obj.getClass(),
                        cachedNodes );
        }
    ...
    private ObjectTypeNode[] getMatchingNodes(final Object obj) throws FactException {
    ...
    public boolean equals(final Object obj) {
        ...
        if ( obj == null || obj.getClass() != Rete.class ) {
            return false;
        }
