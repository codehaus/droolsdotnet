...
public class FunctionFixer {
    ...
    static HashMap map = new HashMap(1000);
    ...
    public String fix(final String raw,
    	...
    	if(!map.containsKey(new Object[]{raw,pattern}))
    	{    		
    		...
    		map.put(new String(raw+pattern.hashCode()), returnVal);
    	}
    	else
    	{
    		int i = 1;
    	}
    	return (String)map.get(new String(raw+pattern.hashCode()));
    }
